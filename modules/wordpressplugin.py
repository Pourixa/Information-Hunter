...
def start():
    ...
    try:
        ...
        for wp in wplist:
            sleep(0.1)
            r=requests.get(target+'/wp-content/plugins/'+wp)
            if r.status_code==200:
                print(Fore.GREEN+' [+] '+target+'/wp-content/plugins/'+wp + ' |  Found')
            else:
                print(Fore.RED+' [-] '+target+'/wp-content/plugins/'+wp + ' |  Not Found')
    except:
        pass
    try:
